...
# TestNode: A peer we use to send messages to babycoind, and store responses.
...
class CompactBlocksTest(BabycoinTestFramework):
    ...
    # This test actually causes babycoind to (reasonably!) disconnect us, so do this last.
    ...
    # Test that babycoind requests compact blocks when we announce new blocks
    ...
    def test_incorrect_blocktxn_response(self, node, test_node, version):
        ...
        # Note that it's possible for babycoind to be smart enough to know we're
    ...
    def test_getblocktxn_handler(self, node, test_node, version):
        # babycoind will not send blocktxn responses for blocks whose height is
