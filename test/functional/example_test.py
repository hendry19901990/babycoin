...
def custom_function():
    ...
    # self.log.info("running custom_function")  # Oops! Can't run self.log outside the BabycoinTestFramework
    pass

class ExampleTest(BabycoinTestFramework):
    # Each functional test is a subclass of the BabycoinTestFramework class.
    ...
    def custom_method(self):
        ...
        BabycoinTestFramework class so other tests can use it."""
