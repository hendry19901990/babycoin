...
class BIP66Test(BabycoinTestFramework):
    ...
    def run_test(self):
        ...
        with mininode_lock:
            ...
            # babycoind is running with multiple script check threads. If script
            # check threads are not in use, then transaction script validation
            # happens sequentially, and babycoind produces more specific reject
            # reasons.
