...
unlocked to sign the Babycoin-Qt.app bundle.
...
allowing somebody to distribute a Babycoin-Qt.app or babycoin-qt-setup.exe with a valid
...
that the babycoin-qt.exe file inside the installer had not been tampered with.
