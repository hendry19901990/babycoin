...
This document provides guidelines for internationalization of the Babycoin Core software.
...
This can be checked by executing `make translate` in the `src` directory, then verifying that `babycoin_en.ts` remains unchanged.
