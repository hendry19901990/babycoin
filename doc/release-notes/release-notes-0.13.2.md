Babycoin Core version 0.13.2 is now available from:

  <https://babycoin.org/bin/babycoin-core-0.13.2/>
...
- #8908 `4a974b2` Update babycoin-qt.desktop (s-matthew-english)
...
- #8932 `106da69` Allow babycoin-tx to create v2 transactions (bbcdrak)
