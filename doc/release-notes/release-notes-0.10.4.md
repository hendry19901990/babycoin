Babycoin Core version 0.10.4 is now available from:

  <https://babycoin.org/bin/babycoin-core-0.10.4/>
...
- #6953 `43c2789` Split babycoin-tx into its own package
- #6953 `dfe0d4d` Include babycoin-tx binary on Debian/Ubuntu
