Babycoin Core version 0.9.2.1 is now available from:

  https://babycoin.org/bin/0.9.2.1/
...
- Lower paytxfee warning threshold from 0.25 BBC to 0.01 BBC
...
- Fix "Start babycoin on system login"
