Babycoin version 0.5.4 is now available for download at:
http://sourceforge.net/projects/babycoin/files/Babycoin/babycoin-0.5.4/
...
http://gitorious.org/babycoin/babycoind-stable/archive-tarball/v0.5.4#.tar.gz
...
Fix Babycoin-Qt notifications under Growl 1.3.
Increase required age of Babycoin-Qt's "not up to date" status from 30 to 90 minutes.
...
Remove wxBabycoin properly when installing Babycoin-Qt over it. (Windows)
