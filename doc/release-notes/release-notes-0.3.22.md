Download URL: https://sourceforge.net/projects/babycoin/files/Babycoin/babycoin-0.3.22/
...
Notable changes:
* Client will accept and relay TX's with 0.0005 BBC fee schedule (users still pay 0.01 BBC per kb, until next version)
...
* IRC is overflowing.  Client now bootstraps to channels #babycoin00 - #babycoin99
