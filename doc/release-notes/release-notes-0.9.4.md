Babycoin Core version 0.9.4 is now available from:

  https://babycoin.org/bin/0.9.4/
...
this update is incompatible with the Babycoin system and could lead to consensus
forks.

Babycoin Core released binaries from https://babycoin.org are unaffected,
as are any built with the gitian deterministic build system.

However, if you are running either

- The Ubuntu PPA from https://launchpad.net/~babycoin/+archive/ubuntu/babycoin
- A third-party or self-compiled Babycoin Core

upgrade to Babycoin Core 0.9.4, which includes a workaround, **before** updating
OpenSSL.
