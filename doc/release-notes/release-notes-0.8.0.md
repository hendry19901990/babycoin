Babycoin-Qt version 0.8.0 is now available from:
  http://sourceforge.net/projects/babycoin/files/Babycoin/babycoin-0.8.0/
...
Mac and Windows binaries are signed with certificates owned by the Babycoin
...
New/changed settings (command-line or babycoin.conf file)
--------------------------------------------------------
