...
#if defined(NDEBUG)
# error "Babycoin cannot be compiled without assertions."
#endif
...
const std::string strMessageMagic = "Babycoin Signed Message:\n";
                              ...
                              bool fOverrideMempoolLimit, const CAmount& nAbsurdFee, std::vector<COutPoint>& coins_to_uncache)
{
...

    {
        ...
        {
            LogPrint(BCLog::MEMPOOL, "replacing tx %s with %s for %s BBC additional fees, %d delta bytes\n",
...
void ThreadScriptCheck() {
    RenameThread("babycoin-scriptch");
