...
#ifndef BABYCOIN_WALLET_WALLET_H
#define BABYCOIN_WALLET_WALLET_H
...
public:
     ...
     * on this babycoin node, and set to 0 for transactions that were created
...
#endif // BABYCOIN_WALLET_WALLET_H
