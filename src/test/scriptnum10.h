...
#ifndef BABYCOIN_TEST_SCRIPTNUM10_H
#define BABYCOIN_TEST_SCRIPTNUM10_H
...
{
/**
 * The ScriptNum implementation from Babycoin Core 0.10.0, for cross-comparison.
 */
public:
